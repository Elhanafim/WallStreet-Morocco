      ...
      tabs: [
        {
          title: 'Maroc',
          symbols: [
            { s: 'CSEMA:MASI', d: 'MASI Index'          },
            { s: 'CSEMA:ATW',  d: 'Attijariwafa Bank'   },
            { s: 'CSEMA:IAM',  d: 'Maroc Telecom'       },
            { s: 'CSEMA:BCP',  d: 'Banque Pop.'         },
            { s: 'CSEMA:LHM',  d: 'LafargeHolcim Maroc' },
            { s: 'CSEMA:CIH',  d: 'CIH Bank'            },
            { s: 'CSEMA:CSR',  d: 'Cosumar'             },
            { s: 'CSEMA:BOA',  d: 'Bank of Africa'      },
            { s: 'CSEMA:WAA',  d: 'Wafa Assurance'      },
          ],
          originalTitle: 'Maroc',
        },
        {
